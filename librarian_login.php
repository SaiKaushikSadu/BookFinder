...
<body>
    <header>
        <!-- <img id="logo" src="https://template68194.motopreview.com/mt-demo/68100/68194/mt-content/uploads/2018/07/mt-1519-logo.png"> -->
       <!-- <div class="right">
    ...
    <section>
        <div class="login">
            <h1 class="heading"><b> Librarian login </b></h1>
           <!-- <input type="text" class="info" placeholder="Enter your name ">
            <input type="text" class="info" placeholder="Enter your branch ">-->
            <form action="librarian_login.php" onsubmit="return isvalid()" method="post">
                <div class="detail">
                <input type="text" class="info" name="library_id" placeholder="Enter your Library ID ">
                </div>
                <div class="detail">
...
$sql="SELECT * FROM librarian_login WHERE library_id='$library_id' AND password='$password'";
...
if($count>0){
    ...
    echo '<script>
            ...
            window.location.href="librarian_login.php";
        </script>';
}
