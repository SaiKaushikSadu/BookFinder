        ...
        <section class="upper">
            <form action="add_student.php" method="post">
                <div class="form_control1">
                    ...
                    <input id="new_student" name="library_id" placeholder="Enter the ID of the new Student"/>
                </div>
                <div class="form_control2">
                    <label for="new_pass">Password</label>
                    <input id="new_password" name="password" placeholder="Enter the Password"/>
                </div>
                <div class="but">
...
$sql="INSERT INTO student_login (library_id,password) VALUES('$library_id','$password')";
